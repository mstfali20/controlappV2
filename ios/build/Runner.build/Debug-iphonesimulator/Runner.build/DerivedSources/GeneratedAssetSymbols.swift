...
extension ImageResource {
    ...
    /// The "BrandingImage" asset catalog image resource.
    static let branding = ImageResource(name: "BrandingImage", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "BrandingImage" asset catalog image.
    static var branding: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .branding)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "BrandingImage" asset catalog image.
    static var branding: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .branding)
#else
        .init()
