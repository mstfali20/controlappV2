...
import 'package:controlapp/src/features/enerji_izleme/energy/presentation/view_model/energy_carbon_cubit.dart';
import 'package:controlapp/src/features/enerji_izleme/energy/presentation/view_model/energy_carbon_state.dart';

class CustomFarkKarbonWidget extends StatelessWidget {
  const CustomFarkKarbonWidget({
    super.key,
    required this.title,
    ...
    required this.consumptionDeviceId,
    required this.productionDeviceId,
    required this.term,
  ...
  final String consumptionDeviceId;
  final String productionDeviceId;
  final String term;
    ...
    return BlocProvider(
      create: (_) => EnergyCarbonCubit(fetchUseCase: getIt())
        ..load(
          ...
          consumptionDeviceId: consumptionDeviceId,
...
class _CustomFarkKarbonView extends StatelessWidget {
  const _CustomFarkKarbonView({
    required this.title,
    required this.backgroundColor,
    required this.leading,
    required this.onTap,
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<EnergyCarbonCubit, EnergyCarbonState>(
      ...
      builder: (context, state) {
        ...
        final treeText =
            state.treeCount != null ? state.treeCount!.toStringAsFixed(0) : '0';
